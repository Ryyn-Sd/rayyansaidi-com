...
const Nav = (props) =>
    <ul className="nav">
        ...
        <li className="navbar"><Link to="/bio/favorites" className={props.act === 3 ? "active" : null}>Favorites</Link></li>
        ...
        <li className="navbar"><Link to="/projects/an" className={props.act === 7 ? "active" : null}>Suggestions</Link></li>
